        ...
        <div class="container">
            ...
            <?php if ($estado === 'Corregir' || $estado === null): ?>
                ...
                <form action="../estudiante/logic/documento-doce.php" class="enviar-tema" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Carga de imágenes de evidencias -->
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Evidencia 1: Realización de prácticas en el puesto de trabajo</label>
                            <input type="file" class="form-control" name="img_practicas_puesto_trabajo" accept="image/*" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Evidencia 2: Puesto de trabajo</label>
                            <input type="file" class="form-control" name="img_puesto_trabajo" accept="image/*" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Evidencia 3: Estudiante y tutor de las prácticas (Entidad Receptora)</label>
                            <input type="file" class="form-control" name="img_estudiante_tutor_entidad" accept="image/*" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Evidencia 4: Cierre de prácticas laborales (Culminación de Prácticas)</label>
                            <input type="file" class="form-control" name="img_cierre_practicas" accept="image/*" required>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered shadow-lg text-center align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $img_practicas_puesto_trabajo; ?>" target="_blank">Ver imagen</a>
                                </td>
                                <td>
                                    <a href="<?php echo $img_puesto_trabajo; ?>" target="_blank">Ver imagen</a>
                                </td>
                                <td>
                                    <a href="<?php echo $img_estudiante_tutor_entidad; ?>" target="_blank">Ver imagen</a>
                                </td>
                                <td>
